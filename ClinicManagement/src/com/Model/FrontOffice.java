...
//parameterized constructor
	...
	public FrontOffice(int roleId, String roleName, int sId, String sName,
			String sDOB, String sGender, String sAddr, String sExp,
			String sPhNo, String sEmail, String username, String password,
			String isActive, String screatedDate, int dId, String dSpec,
			String dQualification, double consultFee, int regId, String pFName,
			String pLName, int age, String pGender, Date pDOB, String pAddr,
			String pPhNo, String pBloodGrp, Date pcreatedDate, int appId,
			String dateOfApp, String consultStatus, int fBillId,
			String billDate, double admFee, int dayId, String dayName,
			int consultId) {
		super();
		this.roleId = roleId;
	...
	public String toString() {
		return "FrontOffice [roleId=" + roleId + ", roleName=" + roleName
				+ ", sId=" + sId + ", sName=" + sName + ", sDOB=" + sDOB
				+ ", sGender=" + sGender + ", sAddr=" + sAddr + ", sExp="
				+ sExp + ", sPhNo=" + sPhNo + ", sEmail=" + sEmail
				+ ", username=" + username + ", password=" + password
				+ ", isActive=" + isActive + ", screatedDate=" + screatedDate
				+ ", dId=" + dId + ", dSpec=" + dSpec + ", dQualification="
				+ dQualification + ", consultFee=" + consultFee + ", regId="
				+ regId + ", pFName=" + pFName + ", pLName=" + pLName
				+ ", age=" + age + ", pGender=" + pGender + ", pDOB=" + pDOB
				+ ", pAddr=" + pAddr + ", pPhNo=" + pPhNo + ", pBloodGrp="
				+ pBloodGrp + ", pcreatedDate=" + pcreatedDate + ", appId="
				+ appId + ", dateOfApp=" + dateOfApp + ", consultStatus="
				+ consultStatus + ", fBillId=" + fBillId + ", billDate="
				+ billDate + ", admFee=" + admFee + ", dayId=" + dayId
				+ ", dayName=" + dayName + ", consultId=" + consultId + "]";
	}
